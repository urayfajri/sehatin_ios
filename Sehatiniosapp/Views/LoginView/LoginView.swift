...
struct LoginView: View {
    ...
    var body: some View {
        NavigationView {
                ...
                VStack {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        VStack(alignment: .trailing, spacing: 0) {
                                ...
                                ZStack(alignment: .bottomLeading) {
                                    ZStack(alignment: .bottomLeading) {
                                        ...
                                        .frame(width: getRelativeWidth(226.0),
                                               ...
                                               alignment: .trailing)
                                        .shadow(color: ColorConstants.Indigo90028, radius: 36, x: 0,
                                                y: 8)
                            ...
                            .hideNavigationBar()
                            .frame(width: getRelativeWidth(355.0), height: getRelativeHeight(226.0),
                                   alignment: .trailing)
                        }
                        .frame(width: getRelativeWidth(355.0), height: getRelativeHeight(226.0),
                               alignment: .trailing)
                        ...
                        VStack {
                            ...
                            Group {
                                HStack {
                                    TextField(StringConstants.kMsgMasukkanEmail,
                                              text: $loginViewModel.groupthreeText)
                                        .font(FontScheme
                                ...
                                .onChange(of: loginViewModel.groupthreeText) { newValue in

                                    loginViewModel.isValidGroupthreeText = newValue
                            ...
                            HStack {
                                Text(StringConstants.kLblPassword)
                                    ...
                                    .frame(width: getRelativeWidth(70.0),
                                           height: getRelativeHeight(20.0), alignment: .topLeading)
                                Spacer()
                                Text(StringConstants.kMsgLupaPasswordA)
                                    .font(FontScheme
                            ...
                            Group {
                                HStack {
                                    TextField(StringConstants.kMsgMasukkanPasswo,
                                              text: $loginViewModel.grouptwoText)
                                        .font(FontScheme
                                            .kProximaNovaRegular(size: getRelativeHeight(12.0)))
                                        .foregroundColor(ColorConstants.Gray700)
                                        .padding()
                                ...
                                .onChange(of: loginViewModel.grouptwoText) { newValue in

                                    loginViewModel.isValidGrouptwoText = newValue
                            ...
                            .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                                       bottomRight: 8.0)
                                    .fill(ColorConstants.Indigo900))
                            .shadow(color: ColorConstants.Bluegray9003d, radius: 24, x: 0, y: 16)
                            .padding(.top, getRelativeHeight(40.0))
                            .padding(.trailing, getRelativeWidth(20.0))
                            HStack {
                                Text(StringConstants.kMsgBelumPunyaAku)
                                    .font(FontScheme
                                ...
                                Spacer()
                                Text(StringConstants.kLblDaftarSekarang)
                                    .font(FontScheme
                                        .kProximaNovaSemibold(size: getRelativeHeight(14.0)))
                                    .fontWeight(.semibold)
                                    .foregroundColor(ColorConstants.Indigo900)
                            ...
                            .frame(width: getRelativeWidth(236.0), height: getRelativeHeight(16.0),
                                   alignment: .center)
                            ...
                            .frame(width: getRelativeWidth(145.0), height: getRelativeHeight(13.0),
                                   alignment: .center)
                            .padding(.top, getRelativeHeight(41.0))
                            .padding(.horizontal, getRelativeWidth(49.0))
                        }
                        .frame(width: getRelativeWidth(355.0), height: getRelativeHeight(346.0),
                               alignment: .trailing)
                        .padding(.vertical, getRelativeHeight(16.0))
                        .padding(.leading, getRelativeWidth(10.0))
                    }
                    ...
                    .alert(isPresented: $loginViewModel.isAlertShow,
                           content: { Alert(title: Text(loginViewModel.alertTitle),
                                            message: Text(loginViewModel.alertDescription),
            ...
            .hideNavigationBar()
            if loginViewModel.isLoaderShow {
                GeometryReader { _ in
                    ActivityLoader(isLoaderShow: $loginViewModel.isLoaderShow)
                }
            }
        }
        .hideNavigationBar()
